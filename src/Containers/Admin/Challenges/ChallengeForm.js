        ...
        <div className="col-12 col-sm-3">
          ...
          <form onSubmit={ this.props.handleSubmit }>
            <div className="form-group">
              ...
              {
                buildFormFields(mergedChallenge, {blacklistKeys: blacklistKeys, textareaKeys: ["body.question", "body.options", "description", "body.feedback", "body.text", "body.help", "body.solution", "body.messaging"]}, (key, url) => {
